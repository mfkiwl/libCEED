...
//TESTARGS(name="channel-entropy") -ceed {ceed_resource} -test_type solver -options_file examples/fluids/channel.yaml -compare_final_state_atol 2e-11 -compare_final_state_filename examples/fluids/tests-output/fluids-navierstokes-channel-entropy.bin -dm_plex_box_faces 5,5,1 -ts_max_steps 5 -state_var entropy
