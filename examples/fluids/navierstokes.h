...
typedef struct {
  ...
  PetscInt  num_tensor_nodes;
  PetscInt  num_nodes_to_remove;
} *SmartSimData;
...
PetscErrorCode VelocityGradientProjectionSetup(Ceed ceed, User user, CeedData ceed_data, ProblemData *problem, StateVariable input_state_var,
