...
PetscErrorCode MatMult_BDDCElementSchur(BDDCApplyContext bddc_ctx, Vec X, Vec Y);
PetscErrorCode FormResidual_BDDCElementSchur(SNES snes, Vec X, Vec Y, void *ctx);
PetscErrorCode MatMult_BDDCSchur(BDDCApplyContext bddc_ctx, Vec X, Vec Y);
